 ...
 * @author HP
 */
public class DriverStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DriverStatus</title>");            
            out.println("</head>");
            out.println("<body>");
           
            String driverEmail=(String) request.getAttribute("driverEmail");
            Driver driver=new Driver();
            driver.setdId(driverEmail);
            DriverDao dao=new DriverDao(ConnectionProvider.getConnection());
            ArrayList list=dao.dStatus(driver);
            request.setAttribute("dStatus", list);
            request.setAttribute("did", driverEmail);
            out.println(driverEmail);
            String driverName=dao.driverName(driver);
            request.setAttribute("driverName", driverName);
            
            RequestDispatcher requestDispatcher=request.getRequestDispatcher("driverstatus.jsp");
