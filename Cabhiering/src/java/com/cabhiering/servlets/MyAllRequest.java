...
public class MyAllRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MyAllRequest</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            ArrayList list=dao.myAllrequest(tr.getTravellerid());

            
            request.setAttribute("myAllrequest", list);
            
            RequestDispatcher rd=request.getRequestDispatcher("/myallrequest.jsp");
