...
public class DriverLoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DriverLoginServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            Driver driver= driverDao.getDriverByEmailAndPassword(driverEmail, driverPassword);
            
            if(driver==null)
            {
                MessageForInvalid mfi=new MessageForInvalid();
                 mfi.setContent("Invalid details ! try with other...");
                 mfi.setType("error");
...
//                
                ...
                RequestDispatcher requestDispatcher=request.getRequestDispatcher("DriverStatus");
