 ...
 * @author HP
 */
public class TravellerResetPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TravellerResetPassword</title>");            
            out.println("</head>");
            out.println("<body>");
...
//         String email= (String)hs.getAttribute("travellerEmail");
           String travellerEmail= request.getParameter("travellerEmail");
            ...
            traveller.settEmail(travellerEmail);
            traveller.settPassword(password);
            int r=new TravellerDao(ConnectionProvider.getConnection()).resetPassword(traveller);
            if(r==1)
            {
