...
public class AllRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AllRequest</title>");            
            out.println("</head>");
            out.println("<body>");
               
            ArrayList al=new AdminDao(ConnectionProvider.getConnection()).getAllDetails();
            request.setAttribute("getAllDetails", al);
