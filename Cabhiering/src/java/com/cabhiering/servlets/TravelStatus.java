 ...
 * @author HP
 */
public class TravelStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TravelStatus</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            travellingRequest.setTravelId(travelId);
            TravellerDao dao=new TravellerDao(ConnectionProvider.getConnection());
            request.setAttribute("travelId", travelId);
            request.setAttribute("travelStatus", dao.travelStatus(travelId));
            request.setAttribute("amount", amount);
            
            
            RequestDispatcher dispatcher=request.getRequestDispatcher("travelstatus.jsp");
