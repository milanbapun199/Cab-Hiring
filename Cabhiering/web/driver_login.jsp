...
<html>
    <head>
        ...
        <style>
            ...
            .bg
            {
                background-image: url('image/jerry-wang-w53Fq_m11ks-unsplash.jpg');
                height: 100%;
                    ...
                    <div class="col-md-4 offset-md-4">
                        <div class="card">
                            <div class="card-header text-center primary-bacground">
                                ...
                                <p style="color: #283593"> Driver Login here</p>
                            ...
                            <div class="card-body">
                                <form action="DriverLoginServlet" method="POST">
                                    <div class="form-group">
                                      ...
                                      <input name="driver_email" required type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                                      <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputPassword1">Password</label>
                                      <input name="driver_password" required type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                                    </div>
                                    
                                    <div class="container text-center"> 
                                        <button type="submit" class="btn btn-primary">Submit</button>
                                        <a  href="forgot_traveller_pwd.jsp" class="frgtpwd1">Forgot password
                                            ?</a>
